package com.tongji.airrowing.user.relation.biz.consumer;
...
import com.tongji.airrowing.user.relation.biz.constant.RedisKeyConstants;
import com.tongji.airrowing.user.relation.biz.domain.dataobject.FansDO;
import com.tongji.airrowing.user.relation.biz.domain.dataobject.FollowingDO;
import com.tongji.airrowing.user.relation.biz.domain.mapper.FansDOMapper;
import com.tongji.airrowing.user.relation.biz.domain.mapper.FollowingDOMapper;
...
@Component
@RocketMQMessageListener(consumerGroup = "airrowing_group_" + MQConstants.AIR_TOPIC_FOLLOW_OR_UNFOLLOW, // Group 组
        topic = MQConstants.AIR_TOPIC_FOLLOW_OR_UNFOLLOW, // 消费的主题 Topic
...
public class FollowUnfollowConsumer implements RocketMQListener<Message> {
    ...
    public void onMessage(Message message) {
        ...
        // 根据 MQ 标签，判断操作类型
        if (Objects.equals(tags, MQConstants.AIR_TAG_FOLLOW)) { // 关注
            handleFollowTagMessage(bodyJsonStr);
        } else if (Objects.equals(tags, MQConstants.AIR_TAG_UNFOLLOW)) { // 取关
