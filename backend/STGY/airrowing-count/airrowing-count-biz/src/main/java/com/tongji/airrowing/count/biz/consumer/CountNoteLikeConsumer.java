...
import com.tongji.airrowing.count.biz.enums.LikeUnlikeNoteTypeEnum;
import com.tongji.airrowing.count.biz.model.dto.AggregationCountLikeUnlikeNoteMqDTO;
import com.tongji.airrowing.count.biz.model.dto.CountLikeUnlikeNoteMqDTO;
...
@Component
@RocketMQMessageListener(consumerGroup = "airrowing_group_" + MQConstants.AIR_TOPIC_COUNT_NOTE_LIKE, // Group 组
        topic = MQConstants.AIR_TOPIC_COUNT_NOTE_LIKE // 主题 Topic
)
@Slf4j
public class CountNoteLikeConsumer implements RocketMQListener<String> {
    ...
    private void consumeMessage(List<String> bodys) {
        ...
        // 异步发送 MQ 消息
        rocketMQTemplate.asyncSend(MQConstants.AIR_TOPIC_COUNT_NOTE_LIKE_2_DB, message, new SendCallback() {
            @Override
