...
import com.tongji.airrowing.count.biz.enums.FollowUnfollowTypeEnum;
import com.tongji.airrowing.count.biz.model.dto.CountFollowUnfollowMqDTO;
...
@Component
@RocketMQMessageListener(consumerGroup = "airrowing_group_" + MQConstants.AIR_TOPIC_COUNT_FOLLOWING, // Group 组
        topic = MQConstants.AIR_TOPIC_COUNT_FOLLOWING // 主题 Topic
)
@Slf4j
public class CountFollowingConsumer implements RocketMQListener<String> { // TODO: Message
    ...
    public void onMessage(String body) {
        ...
        // 异步发送 MQ 消息
        rocketMQTemplate.asyncSend(MQConstants.AIR_TOPIC_COUNT_FOLLOWING_2_DB, message, new SendCallback() {
            @Override
