...
import com.tongji.airrowing.count.biz.constant.RedisKeyConstants;
import com.tongji.airrowing.count.biz.enums.CollectUnCollectNoteTypeEnum;
import com.tongji.airrowing.count.biz.model.dto.AggregationCountCollectUnCollectNoteMqDTO;
import com.tongji.airrowing.count.biz.model.dto.AggregationCountLikeUnlikeNoteMqDTO;
import com.tongji.airrowing.count.biz.model.dto.CountCollectUnCollectNoteMqDTO;
...
@Component
@RocketMQMessageListener(consumerGroup = "airrowing_group_" + MQConstants.AIR_TOPIC_COUNT_NOTE_COLLECT, // Group 组
        topic = MQConstants.AIR_TOPIC_COUNT_NOTE_COLLECT // 主题 Topic
)
@Slf4j
public class CountNoteCollectConsumer implements RocketMQListener<String> {
    ...
    private void consumeMessage(List<String> bodys) {
        ...
        // 异步发送 MQ 消息
        rocketMQTemplate.asyncSend(MQConstants.AIR_TOPIC_COUNT_NOTE_COLLECT_2_DB, message, new SendCallback() {
            @Override
