...
@Component
@RocketMQMessageListener(consumerGroup = "airrowing_group_" + MQConstants.AIR_TOPIC_COUNT_FOLLOWING_2_DB, // Group 组
        topic = MQConstants.AIR_TOPIC_COUNT_FOLLOWING_2_DB // 主题 Topic
)
@Slf4j
